...
let BoardingPage = class BoardingPage {
    constructor(modalController, shopService, router) {
    ...
    registerShop(form) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const setLocationModal = yield this.modalController.create({
            ...
            setLocationModal.onDidDismiss().then((location) => {
                ...
                if (location.data) {
                    ...
                    this.shopService.createShop(form.value).subscribe((res) => {
                        this.router.navigateByUrl("/app");
                    }, (err) => { }, () => { });
                }
            });
            return yield setLocationModal.present();
        });
    }
    ionViewWillLeave() {
