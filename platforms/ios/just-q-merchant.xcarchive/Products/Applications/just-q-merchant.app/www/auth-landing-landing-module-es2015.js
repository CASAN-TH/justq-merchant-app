...
let LandingPage = class LandingPage {
    constructor(router, modalController, lineLogin, fb, authService, alertService) {
        this.router = router;
        this.modalController = modalController;
