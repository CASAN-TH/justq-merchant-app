...
let ReviewPage = class ReviewPage {
    constructor(reviewService, authService, alertService, loading) {
    ...
    getReviewData() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.reviewData = yield this.reviewService.getReviewData(0, 10, this.user.ref1);
        });
    }
    doRefresh(event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.reviewData = yield this.reviewService.getReviewData(0, 10, "");
...
const api_url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/api/reviews";
let ReviewService = class ReviewService {
    constructor(http, storage) {
        this.http = http;
        this.storage = storage;
    }
    getReviewData(pageNo, pageSize, shopId) {
...
//# sourceMappingURL=review-review-module-es2015.js.map