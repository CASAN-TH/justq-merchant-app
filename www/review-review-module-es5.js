...
module.exports = "\n<ion-header>\n  <ion-toolbar>\n    <ion-title>รีวิว</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  \n  <ion-refresher slot=\"fixed\" (ionRefresh)=\"doRefresh($event)\">\n    <ion-refresher-content\n      pullingText=\"ดึงลง เพื่อโหลดข้อมูลใหม่\"\n      refreshingSpinner=\"circles\"\n      refreshingText=\"กำลังโหลดข้อมูล...\">\n    </ion-refresher-content>\n  </ion-refresher>\n\n  <ion-row *ngFor=\"let item of reviewData\">\n    <ion-col size=\"12\">\n      <ion-item no-padding class=\"item-border-right\" lines=\"none\">\n        <ion-avatar slot=\"start\">\n          <img [src]=\"item.createby.profileImageURL\">\n        </ion-avatar>\n        <ion-label>\n          <h3>{{item.createby.displayname}}</h3>\n          <p>\n            <ionic4-star-rating #rating activeIcon=\"ios-star\" defaultIcon=\"ios-star-outline\" activeColor=\"orange\"\n              defaultColor=\"#f4f4f4\" readonly=\"false\" [rating]=\"item.rating\" fontSize=\"15px\" halfStar=\"true\">\n            </ionic4-star-rating>\n          </p>\n        </ion-label>\n        <ion-note text-end>\n          <ion-text class=\"date\">{{item.created | moment:\"ago\"}}</ion-text>\n        </ion-note>\n      </ion-item>\n      <ion-item no-padding class=\"item-border-right\">\n        <ion-row>\n          <ion-col size=\"12\">\n            <ion-label>\n              <ion-text class=\"ion-text-wrap\">{{item.comment}}</ion-text>\n            </ion-label>\n          </ion-col>\n        </ion-row>\n      </ion-item>\n    </ion-col>\n  </ion-row>\n\n  <ion-row>\n    <ion-col text-center size=\"12\" *ngIf=\"reviewData && reviewData.length === 0\">\n      ยังไม่มี รีวิว ร้านของคุณ...\n    </ion-col>\n  </ion-row>\n</ion-content>"
...
/* harmony import */ var _pipe_moment_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../pipe/moment.pipe */ "./src/app/pipe/moment.pipe.ts");
...
var ReviewPageModule = /** @class */ (function () {
    ...
    ReviewPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            declarations: [_review_page__WEBPACK_IMPORTED_MODULE_6__["ReviewPage"], _pipe_moment_pipe__WEBPACK_IMPORTED_MODULE_8__["MomentPipe"]]
        })
    ], ReviewPageModule);
...
var ReviewPage = /** @class */ (function () {
    function ReviewPage(reviewService, authService, alertService, loading) {
    ...
    ReviewPage.prototype.getReviewData = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.reviewService.getReviewData(0, 10, this.user.ref1)];
                    case 1:
                        _a.reviewData = _b.sent();
                        return [2 /*return*/];
                }
            });
        });
    };
    ReviewPage.prototype.doRefresh = function (event) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.reviewService.getReviewData(0, 10, "")];
                    case 1:
                        _a.reviewData = _b.sent();
    ...
    ReviewPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_review_service__WEBPACK_IMPORTED_MODULE_2__["ReviewService"],
...
var api_url = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl + "/api/reviews";
var ReviewService = /** @class */ (function () {
    function ReviewService(http, storage) {
        this.http = http;
        this.storage = storage;
    }
    ReviewService.prototype.getReviewData = function (pageNo, pageSize, shopId) {
        var _this = this;
